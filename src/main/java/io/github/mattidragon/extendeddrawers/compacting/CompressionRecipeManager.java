...
public final class CompressionRecipeManager {
    ...
    private RecipePair findCompressionRecipeForSize(ItemVariant decompressed, World world, boolean isLarge) {
        ...
        var largeCompressionResult = largeCompressionRecipe.get().craft(largeCompressionInventory, world.getRegistryManager());
        ...
        var decompressionResult = decompressionRecipe.get().craft(decompressionInventory, world.getRegistryManager());
    ...
    private RecipePair findDecompressionRecipe(ItemVariant compressed, World world) {
        ...
        var decompressionResult = decompressionRecipe.get().craft(decompressionInventory, registryManager);
        ...
        if (largeCompressionRecipe.isPresent()) {
            var largeCompressionResult = largeCompressionRecipe.get().craft(largeCompressionInventory, registryManager);
        ...
        if (smallCompressionRecipe.isPresent()) {
            var smallCompressionResult = smallCompressionRecipe.get().craft(smallCompressionInventory, registryManager);
