...
public record ClientCategory(int itemRenderDistance,
    ...
    public record IconGroup(Identifier lockedIcon,
        ...
        private static final IconGroup DEFAULT = new IconGroup(id("item/lock"), Identifier.withDefaultNamespace("item/lava_bucket"), Identifier.withDefaultNamespace("item/black_dye"), id("item/dupe_wand"));
