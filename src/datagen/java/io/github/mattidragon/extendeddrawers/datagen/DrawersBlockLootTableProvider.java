...
class DrawersBlockLootTableProvider extends FabricBlockLootSubProvider {
    protected DrawersBlockLootTableProvider(FabricPackOutput packOutput, CompletableFuture<HolderLookup.Provider> registriesFuture) {
