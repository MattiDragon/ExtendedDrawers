    ...
    private static ConfigCategory createClientCategory(ClientCategory.Mutable instance) {
        return ConfigCategory.createBuilder()
                ...
                .option(Option.createBuilder(float.class)
                        .name(Text.translatable("config.extended_drawers.client.itemScale"))
                        .binding(DEFAULT.client().itemScale(), () -> instance.itemScale, value -> instance.itemScale = value)
                        .controller(option -> new FloatFieldController(option, 0, 2, FLOAT_FORMATTER))
                        .tooltip(Text.translatable("config.extended_drawers.client.itemScale.tooltip"))
                        .build())
                .build();
    }
}
